 ...
 */
    ...
    var StylePanel = function(div,plotEditControl,plotting) {
        ...
        this._group = ["基本", "衬线", "军标大小", "线型", "填充", "文本", "子标号",  "箭头类型", "缩放比例", "旋转角度", "图片大小","绘制墙"];
    ...
    StylePanel.prototype.collectionPropertyGridRows = function(graphicObject) {
        ...
        if (null !== graphicObject && undefined !== graphicObject) {
            ...
            //拉伸墙透明度
            var extendWallOpacity = new Object();
            extendWallOpacity.name = this._displayExtendWallName[1];
            extendWallOpacity.value = this._selectedFeature.extendWallOpacity;
        ...
        if (null != updated && selectFeature) {
            switch (updated.name) {
                ...
                case this._displayExtendWallName[1]:
                    selectFeature.extendWallOpacity = updated.value;
                    break;
                default:
                    break;
            }
