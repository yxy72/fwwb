...
(function(){
    ...
    var option = {
        ...
        xAxis: [
            {
                type: 'category',
                data: ['北京', '四川', '湖北', '广东', '上海', '重庆', '湖南','海南','甘肃','贵州','江苏','河北','山东','黑龙江','江西','云南','河南'],
                axisTick: {
                    alignWithLabel: true
                },
                //修改刻度标签
        ...
        series: [
            {
                ...
                type: 'bar',
                barWidth: '60%',
                data: [10, 52, 200, 334, 390, 330, 220,110,36,25,59,31,56,86,123,254,68]
                //item样式 圆角样式
                ,itemStyle:{
                    barBorderRadius:3,
                },
...
function SSMsgStaticReload(){
    ...
    SSMsgControl.title.innerHTML = "当前系统概览";
